  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <p className="mt-8 text-sm text-gray-500 leading-relaxed">
        ...
        flashcards. Upload your own multiple-choice questions, study
        adaptively, and watch topics move from unfamiliar to fully mastered.
        Everything runs entirely in your browser — no server, no account, no
        data leaves your device. Your progress is always private and available
        offline.
      </p>
