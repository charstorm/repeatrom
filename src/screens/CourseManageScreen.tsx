...
export function CourseManageScreen({
  ...
  const displayCourses = focusCourseId
    ? courses.filter((c) => c.id === focusCourseId)
    : courses;
          ...
          {displayCourses.map((c) => (
            ...
            >
              ...
              <div className="flex gap-2">
                <button
                  onClick={() =>
                    setConfirm({ type: "reset", courseId: c.id, name: c.name })
                  }
                ...
                <button
                  onClick={() =>
                    setConfirm({ type: "delete", courseId: c.id, name: c.name })
                  }
